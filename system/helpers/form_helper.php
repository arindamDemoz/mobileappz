...
if ( ! function_exists('ajax_validation_errors'))
{
	function ajax_validation_errors($prefix = '', $suffix = '')
	{
		if (FALSE === ($OBJ =& _get_validation_object()))
		{
			return '';
		...
		return $OBJ->ajax_error_string($prefix, $suffix);
	}
}
...
/**
 * Validation Error array key with first later is capital and append edit (exm: user_name  editUser_name)
 *
 * Returns all the errors associated with a form submission.  This is a helper
 * function for the form validation class.
 *
...
if ( ! function_exists('ajax_validation_on_edit_errors'))
{
